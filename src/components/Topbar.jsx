      ...
      <div className="topbar">
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13.5 21H1.5C0.6 21 0 20.4 0 19.5C0 18.6 0.6 18 1.5 18H13.5C14.4 18 15 18.6 15 19.5C15 20.4 14.4 21 13.5 21ZM22.5 13.5H1.5C0.6 13.5 0 12.9 0 12C0 11.1 0.6 10.5 1.5 10.5H22.5C23.4 10.5 24 11.1 24 12C24 12.9 23.4 13.5 22.5 13.5ZM22.5 6H10.5C9.6 6 9 5.4 9 4.5C9 3.6 9.6 3 10.5 3H22.5C23.4 3 24 3.6 24 4.5C24 5.4 23.4 6 22.5 6Z" fill="#0B0B0B" />
          </svg>

        </button>

        <span className='logo'>
          <Link to="/dashboard"> <img src="/dash-logoNew.png" alt="HR Ludo Logo" className="dash-logo" />  </Link>
        </span>
